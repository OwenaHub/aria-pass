...
export default function EventProgram({ event }: { event: OrganiserEvent }) {
    ...
    return (
        <Sheet>
            ...
            <SheetContent className="px-4 md:min-w-110">
                                ...
                                {editProgram ? (
                                    ...
                                    <div className="flex items-center justify-between mb-7">
                                        ...
                                        <div className="flex items-center gap-2">
                                            <Button onClick={() => setEditedProgram(true)} className="rounded-full cursor-pointer" size={'sm'} variant={'ghost'}>
                                                <Pencil
                                            ...
                                            <fetcher.Form action={`/my-events/${event.slug}/programs`} method={'POST'}>
                                                ...
                                                <input type="hidden" name="program_id" value={item.id} />
                                                <Button className="rounded-full cursor-pointer" size={'sm'} variant={'ghost'}>
                                                    <Trash
